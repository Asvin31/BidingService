...
public class Bidding {
	...
	public Bidding(@NotNull @Size(min = 5, max = 30) @NotEmpty String firstName,
	...
	public String toString() {
		return "Bidding [firstName=" + firstName + ", lastName=" + lastName + ", address=" + address + ", city=" + city
				+ ", state=" + state + ", pincode=" + pincode + ", phoneNumber=" + phoneNumber + ", email=" + email
				+ ", productId=" + productId + ", bidAmount=" + bidAmount + "]";
	}
