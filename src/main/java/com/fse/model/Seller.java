...
public class Seller {
	...
	public Seller(@NotNull @Size(min = 5, max = 30) @NotEmpty String firstName,
			@NotNull @NotEmpty @Size(min = 5, max = 30) String lastName, String address, String city, String state,
			String pincode, @NotNull @NotEmpty @Size(min = 10, max = 10) String phoneNumber,
